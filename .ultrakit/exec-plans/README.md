...
The historical Seer execution-plan corpus was migrated here from the old repository-root execution-plan layout. `.ultrakit/exec-plans/` is the only source of truth now.
...
- `completed/mvp-phase-execution-index.md` — archived legacy MVP/post-MVP execution ledger
